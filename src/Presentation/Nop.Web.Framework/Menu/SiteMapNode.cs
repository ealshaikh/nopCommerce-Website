...
public partial class SiteMapNode
{
    ...
    public static SiteMapNode CreateTopLevelMenuItem(string systemName, string title, string controllerName, string actionName, string iconClass = "", bool visible = true, bool openUrlInNewTab = false)
    {
    ...
    public void AddChildNode(SiteMapNode childNode)
    {
        if (ChildNodes == null)
            ChildNodes = new List<SiteMapNode>();
