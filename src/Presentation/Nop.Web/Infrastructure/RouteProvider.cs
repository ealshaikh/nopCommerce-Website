...
/// </summary>
// Userd with static routes like home page
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(
            ...
            pattern: "Admin/TestProduct/Create",
            defaults: new { area = "Admin", controller = "TestProduct", action = "Create" }
        );

        endpointRouteBuilder.MapControllerRoute(
            name: "Admin.TestProduct.Update",
            pattern: "Admin/TestProduct/Update",
            defaults: new { area = "Admin", controller = "TestProduct", action = "Update" }
        );
